...
const translations: Translations = {
  ...
  'checkout.place_order': { en: 'Place Order', ta: 'ஆர்டர் செய்யுங்கள்', hi: 'ऑर्डर दें' },
  'checkout.placing': { en: 'Placing Order...', ta: 'ஆர்டர் செய்யப்படுகிறது...', hi: 'ऑर्डर दिया जा रहा है...' },
  'checkout.secured': { en: 'Secure Checkout', ta: 'பாதுகாப்பான செக்அவுட்', hi: 'सुरक्षित चेकआउट' },
  'checkout.ssl': { en: 'SSL Encrypted Transaction', ta: 'SSL குறியாக்கப்பட்ட பரிவர்த்தனை', hi: 'एसएसएल एन्क्रिप्टेड लेनदेन' },
  'checkout.order_summary': { en: 'Order Summary', ta: 'ஆர்டர் சுருக்கம்', hi: 'ऑर्डर सारांश' },
  'checkout.card_number': { en: 'Card Number', ta: 'அட்டை எண்', hi: 'कार्ड नंबर' },
  'checkout.expiry': { en: 'Expiry Date', ta: 'காலாவति தேதி', hi: 'समाप्ति तिथि' },
  ...
  'checkout.fast_delivery_desc': { en: 'Guaranteed fresh farm delivery', ta: 'உத்தரவாதமான புதிய பண்ணை விநியோகம்', hi: 'गारंटीकृत ताजा खेत वितरण' },
  'checkout.promo': { en: 'Promotional Code', ta: 'விளம்பர குறியீடு', hi: 'प्रचार कोड' },
  'checkout.enter_code': { en: 'ENTER CODE', ta: 'குறியீட்டை உள்ளிடவும்', hi: 'कोड दर्ज करें' },
  'checkout.remove': { en: 'REMOVE', ta: 'நீக்கவும்', hi: 'हटाएं' },
  'checkout.apply': { en: 'APPLY', ta: 'விண்ணப்பிக்கவும்', hi: 'लागू करें' },
  'checkout.subtotal': { en: 'Subtotal', ta: 'துணைத்தொகை', hi: 'उप-योग' },
  'checkout.discount': { en: 'Discount', ta: 'தள்ளுபடி', hi: 'छूट' },
  'checkout.total': { en: 'Grand Total', ta: 'மொத்த தொகை', hi: 'कुल योग' },

  // Contact Page
  'contact.badge': { en: 'Connect with the farm', ta: 'பண்ணையுடன் இணையுங்கள்', hi: 'खेत से जुड़ें' },
  'contact.title': { en: 'Get in Touch', ta: 'தொடர்பு கொள்ளவும்', hi: 'संपर्क करें' },
  'contact.direct_line': { en: 'Direct Line', ta: 'நேரடி அழைப்பு', hi: 'सीधी लाइन' },
  'contact.email_support': { en: 'Email Support', ta: 'மின்னஞ்சல் ஆதரவு', hi: 'ईमेल सहायता' },
  'contact.main_hub': { en: 'Main Hub', ta: 'முதன்மை மையம்', hi: 'मुख्य केंद्र' },
  'contact.send_msg': { en: 'Send a Message', ta: 'ஒரு செய்தி அனுப்பவும்', hi: 'एक संदेश भेजें' },
  'contact.reply_time': { en: 'We reply within 2 hours on working days.', ta: 'வேலை நாட்களில் 2 மணி நேரத்திற்குள் பதிலளிப்போம்.', hi: 'हम कार्य दिवसों में 2 घंटे के भीतर जवाब देते हैं।' },
  'contact.fullname': { en: 'Full Name *', ta: 'முழு பெயர் *', hi: 'पूरा नाम *' },
  'contact.email': { en: 'Email Address *', ta: 'மின்னஞ்சல் முகவரி *', hi: 'ईमेल पता *' },
  'contact.subject': { en: 'Subject', ta: 'பொருள்', hi: 'विषय' },
  'contact.message': { en: 'Message *', ta: 'செய்தி *', hi: 'संदेश *' },
  'contact.sending': { en: 'Sending...', ta: 'அனுப்பப்படுகிறது...', hi: 'भेजा जा रहा है...' },
  'contact.send_btn': { en: 'Send Message', ta: 'செய்தி அனுப்பவும்', hi: 'संदेश भेजें' },
  'contact.subject.general': { en: 'General Inquiry', ta: 'பொது விசாரணை', hi: 'सामान्य पूछताछ' },
  'contact.subject.order': { en: 'Order Support', ta: 'ஆர்டர் ஆதரவு', hi: 'ஆर्डर सहायता' },
  'contact.subject.farmer': { en: 'Farmer Partnership', ta: 'விவசாயி கூட்டாண்மை', hi: 'किसान साझेदारी' },
  'contact.subject.bulk': { en: 'Bulk/Business Orders', ta: 'மொத்த / வணிக ஆர்டர்கள்', hi: 'थोक/व्यावसायिक ऑर्डर' },

  // Delivery Page
  'delivery.badge': { en: 'Logistics & Fulfillment', ta: 'தளவாடங்கள் மற்றும் பூர்த்தி', hi: 'रसद और पूर्ति' },
  'delivery.title': { en: 'Hyper Fresh Protocol', ta: 'ஹைப்பர் பிரஷ் நெறிமுறை', hi: 'हाइपर फ्रेश प्रोटोकॉल' },
  'delivery.fork': { en: '24h Farm-to-Fork', ta: '24 மணிநேர பண்ணை-முதல்-உணவு', hi: '24 घंटे में खेत से थाली तक' },
  'delivery.fork_desc': { en: 'Our proprietary logistics engine ensures produce harvested at 4 AM reaches your kitchen by 4 PM.', ta: 'அதிகாலை 4 மணிக்கு அறுவடை செய்யப்படும் தயாரிப்புகள் மாலை 4 மணிக்குள் உங்கள் சமையலறையை அடைவதை எங்கள் தளவாட இயந்திரம் உறுதி செய்கிறது.', hi: 'हमारा मालिकाना लॉजिस्टिक्स इंजन यह सुनिश्चित करता है कि सुबह 4 बजे काटी गई फसल शाम 4 बजे तक आपकी रसोई तक पहुँच जाए।' },
  'delivery.slots': { en: 'Delivery Slots', ta: 'விநியோக நேரங்கள்', hi: 'वितरण स्लॉट' },
  'delivery.early': { en: 'Early Bird', ta: 'அதிகாலை', hi: 'जल्दी सुबह' },
  'delivery.mid': { en: 'Mid Day', ta: 'மதியம்', hi: 'दोपहर' },
  'delivery.sunset': { en: 'Sunset', ta: 'மாலை', hi: 'शाम' },
  'delivery.coverage': { en: 'Coverage', ta: 'விநியோகப் பகுதிகள்', hi: 'कवरेज' },
  'delivery.status.90m': { en: 'Live: 90min Delivery', ta: 'நேரடி: 90 நிமிட விநியோகம்', hi: 'लाइव: 90 मिनट में डिलीवरी' },
  'delivery.status.4h': { en: 'Active: 4h Delivery', ta: 'செயலில்: 4 மணிநேர விநியோகம்', hi: 'सक्रिय: 4 घंटे में डिलीवरी' },
  'delivery.status.60m': { en: 'Live: 60min Delivery', ta: 'நேரடி: 60 நிமிட விநியோகம்', hi: 'लाइव: 60 मिनट में डिलीवरी' },
  'delivery.status.next_day': { en: 'Next Day Slots Only', ta: 'அடுத்த நாள் மட்டுமே', hi: 'केवल अगले दिन' },
  'delivery.purity': { en: 'Purity Lock', ta: 'தூய்மை பூட்டு', hi: 'शुद्धता लॉक' },
  ...
  'product.details.continue_shopping': { en: 'CONTINUE SHOPPING', ta: 'தொடர்ந்து வாங்கவும்', hi: 'खरीदारी जारी रखें' },
